...
import pandas as pd
import uproot
from training_variables import xgb_per_telescope_training_variables
...
def load_all_events(input_file, max_events=None):
    ...
    branch_list = [
        ...
        "fpointing_dx",
        "fpointing_dy",
    ] + [var for var in xgb_per_telescope_training_variables()]
...
def apply_models(df, model_dir, selection_mask=None):
    ...
    for n_tel, group_df in grouped:
        ...
        training_vars_with_pointing = xgb_per_telescope_training_variables() + [
            "fpointing_dx",
            "fpointing_dy",
        ]
