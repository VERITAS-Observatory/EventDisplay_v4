...
void VModel3D::doFit()
{
	...
	if( fData3D->fDebug3D )
	{
		cout << "Model3D Fit:   " << fData3D->fSel3D << " " << fData3D->fSaz3D << " " << fData3D->fXcore3D << " " << fData3D->fYcore3D << " " << fData3D->fSmax3D << " " << fData3D->fsigmaL3D << " " << fData3D->fsigmaT3D << " " << fData3D->fNc3D << endl;
	}
	if( fData3D->fDebug3D )
	{
		cout << "Model3D Fit   GOF: " << fData3D->fGOF3D << endl;
	}
