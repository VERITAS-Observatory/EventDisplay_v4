...
const double SEphem::Angle::sc_halfPi;
const double SEphem::Angle::sc_Pi;
const double SEphem::Angle::sc_3HalfPi;
const double SEphem::Angle::sc_twoPi;
const double SEphem::Angle::sc_5HalfPi;
const double SEphem::Angle::sc_degPerRad;
const double SEphem::Angle::sc_rotPerRad;
const double SEphem::Angle::sc_hrsPerRad;
const double SEphem::Angle::sc_radPerDeg;
const double SEphem::Angle::sc_radPerRot;
const double SEphem::Angle::sc_radPerHrs;
...
bool SEphem::Angle::setFromHMSString(std::string str)
{
    ...
    while(i<str.length())
    {
        if((str[i]>='0')&&(str[i]<='9'))hours=hours*10+(str[i++]-'0');
        else if((str[i]==':')||(str[i]=='h')||(str[i]==' ')) { i++; break; }
        else return false;
    }
    ...
    while(i<str.length())
    {
        ...
        else if((str[i]==':')||(str[i]=='m')||(str[i]==' ')) { i++; break; }
        else return false;
    }
...
bool SEphem::Angle::setFromDMSString(std::string str)
{
    ...
    while(i<str.length())
    {
        ...
        else if((str[i]==':')||(str[i]=='d')||(str[i]==' ')) { i++; break; }
        else return false;
    }
