...
{
    if( iD == 0 )      fZombie = true;
    if( iSW.size() == 0 ) fZombie = true;
    if( fZombie ) return false;
...
{
    if( fNoiseFileType == 0 && fGrIsuReader ) return fGrIsuReader->getNoiseVec( iTel, iHitID, iNewTrace );
...
{
    if( fNoiseFileType == 0 && fGrIsuReader ) return fGrIsuReader->getNoiseSample( iTel, iHitID, iSample, iNewTrace );
...
{
    if( fNoiseFileType == 0 && fGrIsuReader ) fGrIsuReader->setSumWindow( iTelID, isw );
}


valarray<double>& VNoiseFileReader::getPeds()
{
    if( fNoiseFileType == 0 && fGrIsuReader ) return fGrIsuReader->getPeds();
...
{
    if( fNoiseFileType == 0 && fGrIsuReader ) return fGrIsuReader->getPedvars();
...
{
    if( fNoiseFileType == 0 && fGrIsuReader ) return fGrIsuReader->getPedvarsAllSumWindows();
...
{
    if( fNoiseFileType == 0 && fGrIsuReader ) return fGrIsuReader->getPedRMS();
...
{
    if( fNoiseFileType == 0 && fGrIsuReader ) return fGrIsuReader->getFullNoiseVec();
...
{
    if( fNoiseFileType == 0 && fGrIsuReader ) return fGrIsuReader->getFullNoiseVec( iTel );
...
{
    if( fNoiseFileType == 0 && fGrIsuReader ) return fGrIsuReader->getFullNoiseVec( iTel, iChannel );
