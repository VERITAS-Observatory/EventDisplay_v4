         ...
         if( 1 )
         {
           ...
           if( sum[tel][channel] > 0. )
           {
             ...
             if( loAverage > 10. )
             {
               ...
               if( HiLo[tel][channel] == 1 ) hscatLow->Fill(loAverage,sum[tel][channel]/6.); 
               if( HiLo[tel][channel] == 1 ) hlinLow->Fill(loAverage);
               if( HiLo[tel][channel] == 0 ) hscatHi->Fill(loAverage,sum[tel][channel]); 
               if( HiLo[tel][channel] == 0 ) hlinHi->Fill(loAverage);
...
// Low Gain
  ...
  if( !bPlot ) gDirectory->GetList()->Delete();
