...
// plotting variables
	...
	double getIntegralFluxError( double iMinEnergy_TeV, double iMaxEnergy_TeV = 1.e6 );
        TF1*   getSpectralFitFunction() { return fFitFunction; }
        double getSpectralFitNormalisationEnergy() { return fSpectralFitFluxNormalisationEnergy; }
        void   print();
        void   setSpectralFitFunction( int iD  = 0 ) { fSpectralFitFunction = iD; }
        void   setSpectralFitFluxNormalisationEnergy( double iE_TeV = 1. ) { fSpectralFitFluxNormalisationEnergy = iE_TeV; }
        ...
        void   setPlottingStyle( int iColor = 1, int iStyle = 1, float iWidth = 2. )
	       { fPlottingEnergySpectrumLineColor = iColor; fPlottingEnergySpectrumLineStyle = iStyle; fPlottingEnergySpectrumLineWidth = iWidth; }
