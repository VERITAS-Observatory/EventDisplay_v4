...
// TeV to erg conversion factor:
   static double sce() { return 1.6022; }
// m^-2 to cm^-2 conversion factor:
   static double sca() { return 1.e-4; }
// Total conversion factor
   static double sc() { return sce()*sca(); }

   public:

   VCTASensitivityRequirements();

   static double Crab_Unit(double E) { return 2.79e-7*pow(E,-2.57); }  // [1/(m^2 s TeV)]
