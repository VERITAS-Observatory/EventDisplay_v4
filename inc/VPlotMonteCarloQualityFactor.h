...
// Revision $Id: VPlotMonteCarloQualityFactor.h,v 1.1.2.2 2010/09/27 12:14:08 gmaier Exp $
...
class VPlotMonteCarloQualityFactor : public VPlotUtilities
{
  ...
  ~VPlotMonteCarloQualityFactor() {}
   ...
   void setEnergyRange( double iEmin = -10., double iEmax = 10. )  { fEnergy_min = iEmin; fEnergy_max = iEmax; }    // log10 [TeV]
