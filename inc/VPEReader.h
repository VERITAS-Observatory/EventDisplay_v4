...
// MC parameters
    ...
    public:
        ...
        string    getDataFormat() { return "PE"; }
        unsigned int getDataFormatNum() { return 6; }
        uint32_t  getEventNumber() { return fPE_eventnumber; }
        uint8_t   getEventType() { return fPE_eventtype; }
        uint8_t   getATEventType() { return fPE_eventtype; }
        ...
        uint32_t  getGPS0() { return 0; }
        uint32_t  getGPS1() { return 0; }
        uint32_t  getGPS2() { return 0; }
        uint32_t  getGPS3() { return 0; }
        uint32_t  getGPS4() { return 0; }
        uint16_t  getGPSYear() { return 0; }
        uint16_t  getATGPSYear() { return 0; }
