...
class VTraceHandler
{
    ...
    public:
        ...
        virtual void setTrace(VVirtualDataReader* iReader, unsigned int iNSamples, double ped, double pedrms, unsigned int iChanID, double iHilo );
                                                  //!< pass the trace values
        virtual void setTrace(VVirtualDataReader*, unsigned int, double, double, unsigned int );
...
// virtual functions
        ...
        virtual double getTraceSum( int fFirst, int fLast, bool fRaw ) { return getQuickSum( fFirst, fLast, fRaw ); }
	...
	virtual vector< float >& getPulseTiming( int fFirst, int fLast, int fTFirst, int fTLast );
        ...
        virtual int    getTraceFitStat()          //!< 3 means successfull fit
        {
            return 3;
        }
