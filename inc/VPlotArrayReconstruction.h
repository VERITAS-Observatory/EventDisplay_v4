...
class VPlotArrayReconstruction : public VPlotUtilities, public TObject
{
    ...
    public:
        ...
        void setPlotLocalTrigger( bool iB = true ) { bPlotLocalTrigger = iB; }
        void setPlotImageAxis( bool iB = true ) { bPlotImageAxes = iB; }
        void setPlotGroundCoordinates( double x1 = -550., double x2 = 550., double y1 = -550., double y2 = 550. );
        void setPlotFOV( double iFOV = 8. ) { fPlotFOV = iFOV; }
        void setPlotPixelSize( double iP = 0.1 ) { fPlotPixelSize = iP; }
