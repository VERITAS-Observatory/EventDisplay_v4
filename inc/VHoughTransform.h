...
class VHoughTransform
{
    ...
    private:
        ...
        TH3D* initAccumulatorArray( int fRMinDpmt, int fRMaxDpmt, int fStepsPerPMTDiameter, unsigned int fTelID ); //Method for initializing the Hough transform accumulator array
