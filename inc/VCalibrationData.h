...
class VCalibrationData
{
	...
	public:
		...
		valarray< valarray < double > > fTS_Peds; //!< time dependent mean pedestal  [time slice][channel]
		vector< valarray< double > > fVPedvars;   //!< pedestal variance (for different sumwindows) [summation window][channel]
		valarray< valarray< valarray < double > > > fTS_fVPedvars; //!< time dependent pedestal variance [time slice][summation window][channel]
		...
		valarray < valarray < double > > fLowGainTS_Peds;       //!< time dependent mean pedestal (low gain)
		vector< valarray<double> > fVLowGainPedvars;            //!< low gain variance (sumwindow)
		valarray< valarray< valarray < double > > > fLowGainTS_fVPedvars; //!< time dependent pedestal variance (for different sumwindows)
