 ...
 * $Author: gmaier $
 * $Date: 2010/03/08 08:01:34 $
 * $Revision: 1.1.10.1.20.3.8.1.2.1 $
 * $Tag$
 *******************************************************************/
...
void slaAltaz ( double ha, double dec, double phi, double *az, double *azd, double *azdd, double *el, double *eld, double *eldd, double *pa, double *pad, double *padd );
...
////void slaAop ( double rap, double dap, double date, double dut, double elongm, double phim, double hm, double xp, double yp, double tdk, double pmb, double rh, double wl, double tlr, double *aob, double *zob, double *hob, double *dob, double *rob );

//void slaAoppa ( double date, double dut, double elongm, double phim, double hm, double xp, double yp, double tdk, double pmb, double rh, double wl, double tlr, double aoprms[14] );

//void slaAoppat ( double date, double aoprms[14] );

//void slaAopqk ( double rap, double dap, double aoprms[14], double *aob, double *zob, double *hob, double *dob, double *rob );

////void slaAtmdsp ( double tdk, double pmb, double rh, double wl1, double a1, double b1, double wl2, double *a2, double *b2 );
...
//void slaCc62s ( float v[6], float *a, float *b, float *r, float *ad, float *bd, float *rd );
...
//void slaCs2c6 ( float a, float b, float r, float ad, float bd, float rd, float v[6] );
...
//void slaDbjin ( char *string, int *nstrt, double *dreslt, int *jf1, int *jf2 );

//void slaDc62s ( double v[6], double *a, double *b, double *r, double *ad, double *bd, double *rd );

void slaDcc2s ( double v[3], double *a, double *b );

////void slaDcmpf ( double coeffs[6], double *xz, double *yz, double *xs, double *ys, double *perp, double *orient );
...
void slaDeuler ( const char *order, double phi, double theta, double psi, double rmat[3][3] );
...
//void slaDs2c6 ( double a, double b, double r, double ad, double bd, double rd, double v[6] );
...
//void slaDtps2c ( double xi, double eta, double ra, double dec, double *raz1, double *decz1, double *raz2, double *decz2, int *n );

//void slaDtpv2c ( double xi, double eta, double v[3], double v01[3], double v02[3], int *n );
...
////void slaEcor ( float rm, float dm, int iy, int id, float fd, float *rv, float *tl );

////void slaEg50 ( double dr, double dd, double *dl, double *db );

//void slaEl2ue ( double date, int jform, double epoch, double orbinc, double anode, double perih, double aorq, double e, double aorl, double dm, double u[], int *jstat );
...
//void slaEuler ( char *order, float phi, float theta, float psi, float rmat[3][3] );

//void slaEvp ( double date, double deqx, double dvb[3], double dpb[3], double dvh[3], double dph[3] );

//void slaFitxy ( int itype, int np, double xye[][2], double xym[][2], double coeffs[6], int *j );

//void slaFk425 ( double r1950, double d1950, double dr1950, double dd1950, double p1950, double v1950, double *r2000, double *d2000, double *dr2000, double *dd2000, double *p2000, double *v2000 );

//void slaFk45z ( double r1950, double d1950, double bepoch, double *r2000, double *d2000 );

//void slaFk524 ( double r2000, double d2000, double dr2000, double dd2000, double p2000, double v2000, double *r1950, double *d1950, double *dr1950, double *dd1950, double *p1950, double *v1950 );

//void slaFk52h ( double r5, double d5, double dr5, double dd5, double *dr, double *dh, double *drh, double *ddh );

//void slaFk54z ( double r2000, double d2000, double bepoch, double *r1950, double *d1950, double *dr1950, double *dd1950 );
...
//void slaH2fk5 ( double dr, double dh, double drh, double ddh, double *r5, double *d5, double *dr5, double *dd5 );

//void slaHfk5z ( double rh, double dh, double epoch, double *r5, double *d5, double *dr5, double *dd5 );
...
//void slaMap ( double rm, double dm, double pr, double pd, double px, double rv, double eq, double date, double *ra, double *da );

//void slaMappa ( double eq, double date, double amprms[21] );

////void slaMapqk ( double rm, double dm, double pr, double pd, double px, double rv, double amprms[21], double *ra, double *da );
...
//void slaOap ( char *type, double ob1, double ob2, double date, double dut, double elongm, double phim, double hm, double xp, double yp, double tdk, double pmb, double rh, double wl, double tlr, double *rap, double *dap );

//void slaOapqk ( char *type, double ob1, double ob2, double aoprms[14], double *rap, double *dap );
...
void slaPda2h ( double p, double d, double a, double *h1, int *j1, double *h2, int *j2 );

////void slaPdq2h ( double p, double d, double q, double *h1, int *j1, double *h2, int *j2 );

//void slaPermut ( int n, int istate[], int iorder[], int *j );

//void slaPertel (int jform, double date0, double date1, double epoch0, double orbi0, double anode0, double perih0, double aorq0, double e0, double am0, double *epoch1, double *orbi1, double *anode1, double *perih1, double *aorq1, double *e1, double *am1, int *jstat );

//void slaPertue ( double date, double u[], int *jstat );

//void slaPlanel ( double date, int jform, double epoch, double orbinc, double anode, double perih, double aorq,  double e, double aorl, double dm, double pv[6], int *jstat );

//void slaPlanet ( double date, int np, double pv[6], int *j );

//void slaPlante ( double date, double elong, double phi, int jform, double epoch, double orbinc, double anode, double perih, double aorq, double e, double aorl, double dm, double *ra, double *dec, double *r, int *jstat );

//void slaPm ( double r0, double d0, double pr, double pd, double px, double rv, double ep0, double ep1, double *r1, double *d1 );

//void slaPolmo ( double elongm, double phim, double xp, double yp, double *elong, double *phi, double *daz ); 
...
void slaPreces ( const char sys[3], double ep0, double ep1, double *ra, double *dc );

//void slaPrenut ( double epoch, double date, double rmatpn[3][3] );

//void slaPv2el ( double pv[], double date, double pmass, int jformr, int *jform, double *epoch, double *orbinc, double *anode, double *perih, double *aorq, double *e, double *aorl, double *dm, int *jstat );

////void slaPv2ue ( double pv[], double date, double pmass, double u[], int *jstat );

//void slaPvobs ( double p, double h, double stl, double pv[6] );

//void slaPxy ( int np, double xye[][2], double xym[][2], double coeffs[6], double xyp[][2], double *xrms, double *yrms, double *rrms );
...
//void slaRdplan ( double date, int np, double elong, double phi, double *ra, double *dec, double *diam );

//void slaRefco ( double hm, double tdk, double pmb, double rh, double wl, double phi, double tlr, double eps, double *refa, double *refb );

//void slaRefcoq ( double tdk, double pmb, double rh, double wl, double *refa, double *refb );
...
//void slaS2tp ( float ra, float dec, float raz, float decz, float *xi, float *eta, int *j );
...
//void slaSvd ( int m, int n, int mp, int np, double *a, double *w, double *v, double *work, int *jstat );

//void slaSvdcov ( int n, int np, int nc, double *w, double *v, double *work, double *cvm );

//void slaSvdsol ( int m, int n, int mp, int np, double *b, double *u, double *w, double *v, double *work, double *x );

//void slaTp2s ( float xi, float eta, float raz, float decz, float *ra, float *dec );

//void slaTp2v ( float xi, float eta, float v0[3], float v[3] );

//void slaTps2c ( float xi, float eta, float ra, float dec, float *raz1, float *decz1, float *raz2, float *decz2, int *n );

//void slaTpv2c ( float xi, float eta, float v[3], float v01[3], float v02[3], int *n ); 
//void slaUe2el ( double u[], int jformr, int *jform, double *epoch, double *orbinc, double *anode, double *perih, double *aorq, double *e, double *aorl, double *dm, int *jstat );
...
//void slaXy2xy ( double x1, double y1, double coeffs[6], double *x2, double *y2 );
