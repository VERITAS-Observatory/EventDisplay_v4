...
class VPlotPPUT
{
	...
	public:
		...
		void setPlotAltitudeRange( float alt_min = 410., float alt_max = 4000. )
		{
			f_plot_alt_min = alt_min;
			f_plot_alt_max = alt_max;
		}
		void setPlotBFieldRange( float b_min = 0., float b_max = 40. )
		{
			f_plot_b_min = b_min;
			f_plot_b_max = b_max;
		}
