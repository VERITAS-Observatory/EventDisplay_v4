...
// plotting functions
   ...
   void            plot_all_maps(char *ihis = "hmap_stereo_sig", double rmax = -1., double zmin = -100., double zmax = -100., double rSource = 0.4, int iN = -1 );
   ...
   vector<sSource> plot_catalogue( TCanvas *c, string iCatalogue = "$OBS_EVNDISP_ANA_DIR/AstroData/Catalogues/BrightStarCatalogue.txt",
