...
class VEnergyThreshold : public TObject
{
    ...
    public:
        ...
        double getEnergy_fixedValue() { return fEnergyThresholdFixedValue; }
        ...
        void setPlottingStyle( int iC = 1, int iS = 21, float iW = 2., float iL = 2. ) { fPlottingMarkerStyle = iS; fPlottingMarkerColor = iC; fPlottingMarkerSize = iW; fPlottingLineWidth = (Width_t)iL; }
        void setPlottingYaxis( double ymin = -1., double ymax = -1. ) { fPlottingYmin = ymin; fPlottingYmax = ymax; }
        bool writeResults();
