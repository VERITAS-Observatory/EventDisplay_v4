...
// (end debug use only)
        ...
        unsigned int getMaxNTelescopes() const { return VDST_MAXTELESCOPES; }
        unsigned int getNArrayReconstructionMethods() const { return fNMethods; }
        unsigned int getNArrayMaxReconstructionMethods() const { return VDST_MAXRECMETHODS; }
        TTree *getTree() { return fTreeSC; }
        ...
        void setMC() { fMC = true; }
        void setNArrayReconstructionMethods( unsigned int iNMethods ) { fNMethods = iNMethods; }
};
#endif
