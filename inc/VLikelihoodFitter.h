...
class VLikelihoodFitter : public VEnergySpectrum
{
	public:
...

		{
			...
			// Getting the minimum threshold as defined in VEnergySpectrum
		...
		*/
		...
		/*
		*		Get the best differential energy spectrum (model dependent)
	...
	private:
		...
		// Apply spectral fit to individual bin
