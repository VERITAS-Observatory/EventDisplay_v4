...
// don't know the difference between hit and trig
        ...
        int                         getNumberofFullTrigger() { return fNumberofFullTrigger[fTelescopeID]; }
        ...
        uint8_t                     getATEventType() { return fEventType; }
        ...
        vector< vector< vector< uint8_t > > > getFullNoiseVec() { return fGrIsuPeds; }
        ...
        std::valarray< double >&    getPeds() { return fPeds[fTelescopeID]; }
        std::valarray< double >&    getPedvars() { return fPedvars[fTelescopeID]; }
        std::vector< valarray<double> >& getPedvarsAllSumWindows() { return fVPedvars[fTelescopeID]; }
        std::valarray< double >&    getPedRMS() { return fPedRMS[fTelescopeID]; }
        ...
        std::vector< double >       getTelElevation() { return fTelElevation; }
        std::vector< double >       getTelAzimuth() { return fTelAzimuth; }
        ...
        void                        setIgnoreCFGVersions( bool iB = false ) {  fIgnoreCFGVersions = iB; }
        void                        setPedestalEventMode( int i_Nped ) { fPedestalMode = true; fNPedestalEvents = i_Nped; }
        ...
        void                        setSumWindow( unsigned int iTelID, int isw ) { if( iTelID < fSumWindow.size() ) fSumWindow[iTelID] = isw; }
        ...
        float                       getLocalTriggerTime( unsigned int iTel ) { return fLocalTriggerTime[iTel]; }
        float                       getLocalDelayedTriggerTime( unsigned int iTel ) { return fLocalDelayedTriggerTime[iTel]; }
                                                  //!< return number of telescopes with local trigger
        unsigned int                getNTelLocalTrigger();
        bool                        hasArrayTrigger() { return !(fArrayTrigger == 0); }
                                                  //!< check if telescope has local trigger
        bool                        hasLocalTrigger( unsigned int iTel );
        double                      getXimpactrot() { return fXimpactrot; }
        double                      getYimpactrot() { return fYimpactrot; }
