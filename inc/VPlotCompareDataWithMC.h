...
class VPlotCompareDataWithMC
{
  ...
  ~VPlotCompareDataWithMC() {}
   ...
   void setNTel( unsigned int iN = 4 ) { fNTel = iN; }
   void setPosterPlot( bool iB = false ) { fPlotPoster = iB; }
   void setPrintName( string iP = "" ) { fPrintName = iP; }
   void setRelativePlotRange( double iMin = 0.03, double iMax = 3 ) { fRelatePlotRange_min = iMin; fRelatePlotRange_max = iMax; }
};
