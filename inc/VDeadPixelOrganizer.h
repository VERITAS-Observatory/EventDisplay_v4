...
class VNGain {
	public :
		...
		bool isLowGain()  { return  fIsLow ; } ;
		bool isHighGain() { return !fIsLow ; } ;
...
class VNPixel {
	public :
		...
		int  getPixid(         ) { return pixid_dbtables ; } ;
...
class VNTelescope {
	public :
		...
		void setNpix ( int npixels ) { npix = npixels ; } ;
		int  getNpix (             ) { return npix    ; } ;
		void setTelid( int tid     ) { fTelID = tid   ; } ;
		int  getTelid(             ) { return fTelID  ; } ;
...
class VDeadPixelOrganizer {
	public :
		...
		void     setNtel(      int    ntelescopes ) { ntel = ntelescopes     ; } ;
		int      getNtel(                         ) { return ntel            ; } ;
		void     setNpix(      int    npixels     ) { npix = npixels         ; } ;
		int      getNpix(                         ) { return npix            ; } ;
