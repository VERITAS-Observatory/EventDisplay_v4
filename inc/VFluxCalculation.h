...
// graphs
    ...
    public:
        ...
        VFluxCalculation();
        VFluxCalculation( string ifile, unsigned int iTot = 1, int iRunMin = 0, int iRunMax = 100000, double iMJDMin = -99., double iMJDMax = -99., bool iDebug = true );
