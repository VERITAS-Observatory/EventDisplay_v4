...
// R
      ...
      if( bPoster ) setHistogramAtt( hR_sims[i], 2, 3, 2, 20, 1 );
      else          setHistogramAtt( hR_sims[i], 2, 3, 1, 20, 1 );
      ...
      if( bPoster ) setHistogramAtt( hR_diff[i], 1, 3, 2, 21, 1 );
      else          setHistogramAtt( hR_diff[i], 1, 3, 1, 21, 1 );
