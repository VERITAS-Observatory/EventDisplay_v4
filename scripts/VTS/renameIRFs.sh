...
# eventdisplay v480 is a 'pure' BDT release, meaning that the code for the regular analysis did not change.
# Thus, the content of the (non-BDT) IRFs did not change, but the filename does (v470 -> v480). 
...
# begin help message
echo "
This is a script to link/copy/mv v470 IRFs to confirm to v480 file name standards.
Usage: $0 <v470_dir> <v480_dir> [command]
